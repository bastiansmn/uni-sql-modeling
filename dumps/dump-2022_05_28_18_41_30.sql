...
CREATE TABLE public.navires (
    ...
    CONSTRAINT valid_categorie CHECK (((categorie >= 1) AND (categorie <= 5)))
);
...
--
-- Name: CONSTRAINT valid_categorie ON navires; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON CONSTRAINT valid_categorie ON public.navires IS 'Permet de vérifier si la catégorie est comprise entre 1 et 5';
...
INSERT INTO public.navires_type (type_id, name) VALUES (1, 'Flûte');
INSERT INTO public.navires_type (type_id, name) VALUES (2, 'Gallion');
INSERT INTO public.navires_type (type_id, name) VALUES (3, 'Gabare');
